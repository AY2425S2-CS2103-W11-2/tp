...
public class CommandTestUtil {
    ...
    public static final String VALID_COMPANY_AMY = "Apple";
    public static final String VALID_COMPANY_BOB = "Google";
    public static final String VALID_POSITION_AMY = "Software Engineer";
    public static final String VALID_POSITION_BOB = "Software Developer";
    public static final String VALID_TAG_HUSBAND = "husband";
    public static final String VALID_TAG_FRIEND = "friend";
    public static final String VALID_IMPORTANCE_AMY = "High";
    public static final String VALID_IMPORTANCE_BOB = "Medium";
    ...
    static {
        DESC_AMY = new EditPersonDescriptorBuilder().withName(VALID_NAME_AMY)
                ...
                .withPosition(VALID_POSITION_AMY).withTags(VALID_TAG_FRIEND).withCompany(VALID_IMPORTANCE_AMY)
                .withImportance(VALID_IMPORTANCE_AMY).build();
        DESC_BOB = new EditPersonDescriptorBuilder().withName(VALID_NAME_BOB)
                .withPhone(VALID_PHONE_BOB).withEmail(VALID_EMAIL_BOB).withCompany(VALID_COMPANY_BOB)
                .withPosition(VALID_POSITION_BOB).withTags(VALID_TAG_HUSBAND, VALID_TAG_HUSBAND)
