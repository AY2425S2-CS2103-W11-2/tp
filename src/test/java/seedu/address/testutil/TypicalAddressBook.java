...
public class TypicalAddressBook {
    ...
    public static final Person ALICE = new PersonBuilder().withName("Alice Pauline")
            ...
            .withTags("friends").withImportance("High").build();
    public static final Person BENSON = new PersonBuilder().withName("Benson Meier")
            .withEmail("johnd@example.com").withPhone("98765432")
            .withCompany("Microsoft").withPosition("Product Manager")
            .withTags("owesMoney", "friends").withImportance("Medium").build();
    public static final Person CARL = new PersonBuilder().withName("Carl Kurz").withPhone("95352563")
            .withEmail("heinz@example.com")
            .withCompany("Tesla").withPosition("Mechanical Engineer").withImportance("Low").build();
    ...
    public static final Person ELLE = new PersonBuilder().withName("Elle Meyer").withPhone("9482224")
            ...
            .withCompany("Meta").withPosition("UI/UX Designer").withImportance("Medium").build();
    public static final Person FIONA = new PersonBuilder().withName("Fiona Kunz").withPhone("9482427")
            .withEmail("lydia@example.com")
            .withCompany("Netflix").withPosition("Marketing Specialist").withImportance("Low").build();
    public static final Person GEORGE = new PersonBuilder().withName("George Best").withPhone("9482442")
            .withEmail("anna@example.com")
            .withCompany("Apple").withPosition("Hardware Engineer").withImportance("High").build();
    ...
    public static final Person HOON = new PersonBuilder().withName("Hoon Meier").withPhone("8482424")
            ...
            .withCompany("Oracle").withPosition("Database Administrator").withImportance("Low").build();
    public static final Person IDA = new PersonBuilder().withName("Ida Mueller").withPhone("8482131")
            .withEmail("hans@example.com")
            .withCompany("IBM").withPosition("Cybersecurity Analyst").withImportance("Medium").build();

    // Manually added - Person's details found in {@code CommandTestUtil}
    public static final Person AMY = new PersonBuilder().withName(VALID_NAME_AMY).withPhone(VALID_PHONE_AMY)
            .withEmail(VALID_EMAIL_AMY)
            .withCompany(VALID_COMPANY_AMY).withPosition(VALID_POSITION_AMY)
            .withTags(VALID_TAG_FRIEND).withImportance(VALID_IMPORTANCE_AMY).build();
    public static final Person BOB = new PersonBuilder().withName(VALID_NAME_BOB).withPhone(VALID_PHONE_BOB)
            .withEmail(VALID_EMAIL_BOB).withCompany(VALID_COMPANY_BOB)
            .withPosition(VALID_POSITION_BOB).withTags(VALID_TAG_HUSBAND, VALID_TAG_FRIEND)
