...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + NAME_DESC_BOB + EMAIL_DESC_BOB + PHONE_DESC_BOB
                + COMPANY_DESC_BOB + POSITION_DESC_BOB + TAG_DESC_FRIEND, new AddCommand(expectedPerson));
    ...
    public void parse_repeatedNonTagValue_failure() {
        String validExpectedPersonString = NAME_DESC_BOB + EMAIL_DESC_BOB + PHONE_DESC_BOB
                + COMPANY_DESC_BOB + POSITION_DESC_BOB + TAG_DESC_FRIEND;
        ...
        assertParseFailure(parser,
                validExpectedPersonString + PHONE_DESC_AMY + EMAIL_DESC_AMY + NAME_DESC_AMY + COMPANY_DESC_AMY
                        + POSITION_DESC_AMY + validExpectedPersonString,
    ...
    public void parse_optionalFieldsMissing_success() {
        ...
        assertParseSuccess(parser, NAME_DESC_AMY + EMAIL_DESC_AMY + PHONE_DESC_AMY + COMPANY_DESC_AMY
                + POSITION_DESC_AMY, new AddCommand(expectedPerson));
    }
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, NAME_DESC_BOB + EMAIL_DESC_BOB + PHONE_DESC_BOB + INVALID_COMPANY_DESC
                + POSITION_DESC_BOB + TAG_DESC_HUSBAND + TAG_DESC_FRIEND, Company.MESSAGE_CONSTRAINTS);
        ...
        assertParseFailure(parser, INVALID_NAME_DESC + EMAIL_DESC_BOB + PHONE_DESC_BOB + INVALID_COMPANY_DESC
                + VALID_COMPANY_BOB + POSITION_DESC_BOB, Name.MESSAGE_CONSTRAINTS);
